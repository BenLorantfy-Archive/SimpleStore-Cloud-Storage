...
| Last Tested By           | [BenLorantfy](https://github.com/BenLorantfy)                                                                                                   | 
| Actual Results           | Client traps the exception and report directory exists                                                                                                                                                                                                            | 
| Extra Notes              |                                                                                                                                                                                                            | 
| Actual Results (Unit)    | Client traps the exception and report directory exists                                                                                                                                                                                                            | 
| Actual Results (Mannual) | Client traps the exception and report directory exists                                                                                                                                                                                                          | 
| Extra Notes              |                                                                                                                                                                                                       | 
...
| Extra Notes              |                                                                                                                                                                                                            | 
| Actual Results (Unit)    |                                                                                                                                                                                                            | 
| Actual Results (Mannual)  Upload takes place (no error given) |                                                                                                                                                                                                            | 
| Extra Notes              |                                                                                                                                                                                                       | 
...
| Last Tested Date         |                                                                                                 | 
| Last Tested Version      |                                                                                                  | 
| Last Tested Commit      |ec016e2                                                                                                | 
| Last Tested By           |                                                                                            | 
| Actual Results             Client traps exception (directory already exists) and report back |                                                                                                                                                                                                            | 
| Extra Notes             Initially see hiddenStuff, myStuff, yourStuff directories. |                                                                                                                                                                                                            | 
| Actual Results (Unit)    |                                                                                                                                                                                                            | 
| Actual Results (Mannual)  Client traps exception (directory already exists) and report back |                                                                                                                                                                                                            | 
| Extra Notes              |                                                                                                                                                                                                       | 
...
| Last Tested Date         | Nov 22nd 2016                                                                             | 
| Last Tested Version      | 0.0.0                                                                                            | 
| Last Tested Commit       | bd73ac5                                                                                         | 
| Last Tested By           | [abasheer-cc](https://github.com/abasheer-cc)                                                                       | 
| Actual Results           | Client creates directory <TeamNameHere> in the HOST subdirectory and allows login                                                                                                                                                                                                           | 
| Extra Notes              |                                                                                                                                                                                                            | 
| Actual Results (Unit)    |                                                                                                                                                                                                            | 
| Actual Results (Mannual) | Client creates directory <TeamNameHere> in the HOST subdirectory and allows login                                                                                                                                                                                                           | 
| Extra Notes              |                                                                                                                                                                                                       | 
...
| Last Tested Commit       | bd73ac5                                                                                                | 
| Last Tested By           |                                                                                            | 
| Actual Results          Client creates directories |                                                                                                                                                                                                            | 
| Extra Notes              |                                                                                                                                                                                                            | 
| Actual Results (Unit)    |                                                                                                                                                                                                            | 
| Actual Results (Mannual) Client creates directories |                                                                                                                                                                                                            | 
| Extra Notes              |                                                                                                                                                                                                       | 
...
| Last Tested Commit       |  bd73ac5                                                                                               | 
| Last Tested By           |                                                                                            | 
| Actual Results          nothing happened (folder upload not working) |                                                                                                                                                                                                            | 
| Extra Notes              |                                                                                                                                                                                                            | 
| Actual Results (Unit)    |                                                                                                                                                                                                            | 
| Actual Results (Mannual) nothing happened (folder upload not working) |                                                                                                                                                                                                            | 
| Extra Notes              |                                                                                                                                                                                                       | 
...
Client creates directories as required and copies files as needed -- all 3 files shown in dir structure and client| 
| Extra Notes              |                                                                                                                                                                                                            | 
| Actual Results (Unit)    |                                                                                                                                                                                                            | 
| Actual Results (Mannual) Client creates directories as required and copies files as needed -- all 3 files shown in dir structure and client |                                                                                                                                                                                                            | 
| Extra Notes              |                                                                                                                                                                                                       | 
...
| Last Tested Commit       | bd73ac5                                                                                                | 
| Last Tested By           |                                                                                            | 
| Actual Results Client creates directories as required and copies files as needed          |                                                                                                                                                                                                            | 
| Extra Notes              |                                                                                                                                                                                                            | 
| Actual Results (Unit)    |                                                                                                                                                                                                            | 
